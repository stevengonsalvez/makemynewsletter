...
class BlogSummary(BaseModel):
    ...
    Attributes:
        source_url (HttpUrl): The URL of the blog post.
    ...
    """
    source_url: HttpUrl = Field(..., description="The source URL of the blog post.")
    ...
    content: str = Field(..., description="The summarised content of the blog post as bullets.")
